...
dbt_run_bronze = BashOperator(
    ...
    bash_command="docker exec dbt-airflow-dataops-dbt-1 dbt run --select bronze --project-dir /usr/app/dbt",
    dag=dag,
)
...
dbt_test_bronze = BashOperator(
    ...
    bash_command="docker exec dbt-airflow-dataops-dbt-1 dbt test --select bronze --project-dir /usr/app/dbt",
    dag=dag,
)
